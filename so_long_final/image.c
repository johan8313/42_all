...
/*   Updated: 2024/04/12 10:54:04 by johmarti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	game->img.path.wall = "./textures/wall.xpm";
	game->img.path.characters = "./textures/characters.xpm";
	game->img.path.coin = "./textures/coin.xpm";
	game->img.path.empty = "./textures/empty.xpm";
	game->img.path.exit = "./textures/exit.xpm";
}
